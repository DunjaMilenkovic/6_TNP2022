...
\begin{table}
    ...
    \begin{tabular}{ |c|c|c|c| }
        ...
        \hline
        Oboje računaju svoje ključeve & $a, A=g^a \mod p $ & $g, p$ & $b, B=g^b \mod p$ \\
        \hline
        Razmenjuju se javni ključevi & $a, A, B$ & $g, p, A, B$ & $b, B, A $ \\
        \hline
        Oboje izračunaju isto, tajno K & 
        {$\!\begin{aligned}
        ...
        \hline
    \end{tabular}
    \caption{\textbf{ovo je baš očajna tabela}}
