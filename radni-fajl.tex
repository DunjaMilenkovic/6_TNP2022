...
\abstract{
    U ovom radu predstavićemo Diffie-Hellman algoritam kao važan deo metoda kojim se kriptografija koristi u cilju osiguravanja digitalne komunikacije. Pokušaćemo da damo pregled najvažnijih informacija koje su potrebne za upoznavanje sa datom temom – od predstavljanja samog algoritma i njegovog načina rada, do njegove praktične primene, ali i potencijalnih nedostataka.
}
