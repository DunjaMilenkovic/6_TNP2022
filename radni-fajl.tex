...
Komunikacija na internetu bila bi potpuno nezamisliva bez postojanja kriptografije. Diffie-Hellman algoritam, kao jedna od njenih osnovnih tehnika, omogućava nam bezbedno i efikasno međusobno povezivanje i razmenu informacija. Princip njegovog rada zasniva se na korišćenju privatnog i javnog ključa za enkripciju, čime se uvodi problem diskretnog logaritma kao prepreka koja potencijalnom napadaču značajno otežava dešifrovanje ključeva, pa tako i dolazak do informacija koje njemu nisu bile namenjene. Međutim, i ovde postoje nedostaci koji u retkim situacijama mogu dovesti upravo do toga da napadač uspe u dešifrovanju i domogne se razmenjenih poruka i informacija. Ovaj problem i pokušaj njegovog rešavanja ili istraživanje drugih kriptografskih metoda i njihovo poređenje sa datim, u cilju pronalaska najbolje, mogao bi biti predmet nekih od narednih istraživanja i radova na datu temu.
